...
public class Menu {
    ...
    void performSelectedAction() {
        ...
        do {
            ...
            if (menuName != null && !menuName.equals(QuitMenuItem.MENU_NAME) && !menuName.equals(LogOutMenuItem.MENU_NAME))
                displayMenu();
        }
        while (menuName == null || (!menuName.equals(LogOutMenuItem.MENU_NAME) && !menuName.equals(QuitMenuItem.MENU_NAME)));
    }
